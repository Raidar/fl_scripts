...
--    local editors=ctxdata and ctxdata.editor
    ...
    for i=0,count-1 do
        ...
        wind.Current = (band(wind.Flags, flags.WIF_CURRENT) ~= 0)
        wind.Modified = (band(wind.Flags, flags.WIF_MODIFIED) ~= 0)
